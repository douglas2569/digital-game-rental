CREATE DATABASE IF NOT EXISTS games CHARACTER SET utf8 COLLATE utf8_general_ci;
...
`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 `name` VARCHAR(30) NOT NULL,    
  ...
  `producer_fk` int(11) NOT NULL,  
   FOREIGN KEY (producer_fk) REFERENCES producers(id),
   
   `gender_fk` int(11) NOT NULL,
   FOREIGN KEY (gender_fk) REFERENCES genres(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `genres` (`gender`) VALUES
('Ação'),
('Aventura'),
('Terror'),
('Estratégia'),
...
INSERT INTO `producers` (`producer`,`country`)VALUES
('Microsoft', 'EUA'),
('Tencent', 'China'),
('Nintendo', 'Japão'),
('Sony', 'Japão'),
