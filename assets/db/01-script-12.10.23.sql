...
CREATE TABLE `games` (
  ...
  CONSTRAINT `games_ibfk_2` FOREIGN KEY (`gender_fk`) REFERENCES `genres` (`id`)
...
INSERT INTO `genres` VALUES (1,'Ação'),(2,'Aventura'),(3,'Terror'),(4,'Estratégia'),(5,'RPG'),(6,'Esporte'),(7,'Corrida'),(8,'Tabuleiro'),(9,'Puzzle'),(10,'Luta'),(11,'Musical');
